...
/**
 * Custom Preference was realised via
 * http://stackoverflow.com/questions/20758986/android-preferenceactivity-dialog-with-number-picker
 * Enables the scowling functionality to select a birth year inside the preferences
 */
public class NumberPickerPreference extends DialogPreference {

    // allowed range specified here
    public static final int MAX_VALUE = 2015;
    public static final int MIN_VALUE = 1915;
